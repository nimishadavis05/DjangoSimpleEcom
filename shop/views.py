...
def home(request,c_slug=None):
	...
	if c_slug!=None:
		...
		product=products.objects.filter(category_name=c_page,available=True)
	else:
	...
	# return render(request,'index.html',{'pr':prod,'ct':c_page})

def prodDetails(request,c_slug,product_slug):
	try:
		prod=products.objects.get(category_name__slug=c_slug,slug=product_slug)
